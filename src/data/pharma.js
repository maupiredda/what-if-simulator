...
export const ganttVehicles = [
  {
    ...
    label: 'V1 — Cold chain',
    deliveries: [
      { name: 'F. Sant Ambrogio', start: 7.5, duration: 0.6, type: 'cold' },
      { name: 'F. Brera', start: 8.4, duration: 0.4, type: 'cold' },
      { name: 'F. Aurora', start: 9.0, duration: 0.5, type: 'cold' },
      { name: 'F. Manzoni', start: 9.8, duration: 0.7, type: 'cold' },
      { name: 'F. del Duomo', start: 10.8, duration: 0.5, type: 'cold' },
      { name: 'F. Verdi', start: 11.6, duration: 0.5, type: 'cold' },
    ],
  },
  {
    id: 'V2',
    label: 'V2 — Urgenze',
    deliveries: [
      { name: 'F. Garibaldi (URG)', start: 7.0, duration: 0.4, type: 'urgent' },
      { name: 'F. Italia (URG)', start: 8.0, duration: 0.5, type: 'urgent' },
      { name: 'F. San Marco', start: 9.0, duration: 0.5, type: 'standard' },
      { name: 'F. Dante (URG)', start: 13.0, duration: 0.4, type: 'urgent' },
      { name: 'F. Centrale (URG)', start: 16.5, duration: 0.5, type: 'urgent' },
    ],
  },
  {
    id: 'V3',
    label: 'V3 — Std',
    deliveries: [
      { name: 'F. Roma', start: 8.0, duration: 0.6, type: 'standard' },
      { name: 'F. Milano', start: 9.0, duration: 0.5, type: 'standard' },
      { name: 'F. Torino', start: 10.0, duration: 0.5, type: 'standard' },
      { name: 'F. Verona', start: 14.0, duration: 0.6, type: 'standard' },
      { name: 'F. Padova', start: 15.2, duration: 0.5, type: 'standard' },
    ],
  },
  {
    id: 'V4',
    label: 'V4 — Std',
    deliveries: [
      { name: 'F. Bologna', start: 8.5, duration: 0.5, type: 'standard' },
      { name: 'F. Firenze', start: 9.5, duration: 0.5, type: 'standard' },
      { name: 'F. Pisa', start: 13.5, duration: 0.6, type: 'standard' },
      { name: 'F. Siena', start: 14.8, duration: 0.5, type: 'standard' },
      { name: 'F. Lucca', start: 15.8, duration: 0.5, type: 'standard' },
    ],
  },
  {
    id: 'V5',
    label: 'V5 — Cold chain',
    deliveries: [
      { name: 'F. Genova', start: 7.5, duration: 0.6, type: 'cold' },
      { name: 'F. Savona', start: 8.5, duration: 0.5, type: 'cold' },
      { name: 'F. La Spezia', start: 9.5, duration: 0.5, type: 'cold' },
      { name: 'F. Sanremo', start: 13.0, duration: 0.5, type: 'cold' },
      { name: 'F. Imperia', start: 14.0, duration: 0.5, type: 'cold' },
    ],
  },
  {
    id: 'V6',
    label: 'V6 — Std',
    deliveries: [
      { name: 'F. Como', start: 8.5, duration: 0.5, type: 'standard' },
      { name: 'F. Lecco', start: 9.5, duration: 0.5, type: 'standard' },
      { name: 'F. Bergamo', start: 13.5, duration: 0.5, type: 'standard' },
      { name: 'F. Brescia', start: 14.5, duration: 0.5, type: 'standard' },
    ],
  },
  {
    id: 'V7',
    label: 'V7 — Notturna',
    deliveries: [
      { name: 'Ospedale Niguarda', start: 21.0, duration: 0.7, type: 'night' },
      { name: 'Ospedale San Raffaele', start: 22.0, duration: 0.6, type: 'night' },
      { name: 'Pronto Soccorso Centrale', start: 23.0, duration: 0.5, type: 'night' },
      { name: 'Guardia Medica Nord', start: 24.0, duration: 0.5, type: 'night' },
      { name: 'Guardia Medica Sud', start: 24.8, duration: 0.5, type: 'night' },
    ],
  },
  {
    id: 'V8',
    label: 'V8 — Std',
    deliveries: [
      { name: 'F. Varese', start: 8.0, duration: 0.5, type: 'standard' },
      { name: 'F. Busto', start: 9.0, duration: 0.5, type: 'standard' },
      { name: 'F. Gallarate', start: 14.0, duration: 0.5, type: 'standard' },
      { name: 'F. Saronno', start: 15.0, duration: 0.5, type: 'standard' },
    ],
  },
]
